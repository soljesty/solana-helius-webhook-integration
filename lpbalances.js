...
ws.on('message', async function incoming(data) {
    ...
    try {
        ...
        // console.log("🚀 ~ incoming ~ instructions:", instructions)
        // instructions.forEach(instruction => {
        //     const index = instruction.index;
        //     console.log("🚀 ~ incoming ~ index:", index)
        //     const instructionsAAA = instruction.instructions;
        //     // console.log("🚀 ~ incoming ~ instructionsAAA:", instructionsAAA)
        //     instructionsAAA.forEach(subInstruction => {
        //         // if(subInstruction.parsed)
        //         console.log("subInstruction: ", subInstruction)
        //     })
        //     // // if(instructionsAAA.parsed.type == "transfer") {
        //     //     const instructionsInfo = instructionsAAA.parsed.info
        //     //     console.log("🚀 ~ incoming ~ instructionsInfo:", instruction)
        //     // // }
        // });
        // console.log("accountKeys: ", result.transaction.transaction.message.accountKeys);
        // console.log("addressTableLookups: ", result.transaction.transaction.message.addressTableLookups);
